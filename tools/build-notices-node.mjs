...
// No `Generated YYYY-MM-DD` line: this file is regenerated by CI on every
// build, and a date that changes daily makes verify-attributions diff
// against committed NOTICES drift on calendar boundaries even when no
// dep changed. Release date is captured by the git tag instead.

let out = ''
out += `# NOTICES — Node.js production dependencies\n\n`
out += `Generated from \`license-checker --production\` over **${total} packages**.\n\n`
