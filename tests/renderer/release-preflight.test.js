...
//
// START_MODULE_MAP
//   consistentEvidence - Complete v2.1.14-beta version fixture.
//   workspaceRoot - GRACE 4 synchronized symbol
// END_MODULE_MAP
//
// START_CHANGE_SUMMARY
//   LAST_CHANGE: 2026-09-24 v2.6.0 - advance the release fixture to the native-print + heading-navigation release v2.1.14-beta (C-18, C-19).
//   PREVIOUS_LATEST: 2026-09-22 v2.5.0 - advance the release fixture to the smart-paste + markdown-hygiene release v2.1.14-beta (C-16, C-17).
//   PREVIOUS_LATEST: 2026-09-21 v2.4.0 - advance the release fixture to the live-reload-scroll/mas/e2e-gates release v2.1.14-beta (C-2 R-9, C-15 T-M1..T-M5, P0 proposals).
...
//   PREVIOUS_OLDER: 2026-08-10 v2.0.0 - advance the release fixture to the async-race hotfix v2.1.7-beta.
...
const consistentEvidence = {
  packageJson: '2.1.14-beta',
  packageLock: '2.1.14-beta',
  packageLockRoot: '2.1.14-beta',
  cargoWorkspace: '2.1.14-beta',
  cargoLockMark: '2.1.14-beta',
  tauriConfig: '2.1.14-beta'
}
...
describe('M-046 release version preflight', () => {
  it('accepts one exact metadata version and matching release tag', () => {
    expect(
      validateVersionEvidence(consistentEvidence, 'v2.1.14-beta')
    ).toEqual({
      version: '2.1.14-beta',
      tag: 'v2.1.14-beta',
      sourceCount: 6
  ...
  it('CLI emits the stable success marker for the target tag', () => {
    const result = spawnSync(
      process.execPath,
      ['tools/release-preflight.mjs', '--tag', 'v2.1.14-beta'],
