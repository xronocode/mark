...
#### Windows
- 请查看 [发布页面](https://github.com/Tkaixiang/marktext/releases)！
- 测试环境：Windows 11
...
#### Windows
- 請查看 [發布頁面](https://github.com/Tkaixiang/marktext/releases)！
- 測試環境：Windows 11
...
#### Windows
- [릴리스 페이지](https://github.com/Tkaixiang/marktext/releases)를 확인하세요!
- 테스트 환경: Windows 11
...
#### Windows
- [リリースページ](https://github.com/Tkaixiang/marktext/releases)をご確認ください！
- テスト環境：Windows 11
...
#### Windows
- ¡Simplemente consulta la [Página de Lanzamientos](https://github.com/Tkaixiang/marktext/releases)!
...
#### Windows
- Consultez simplement la [Page des Versions](https://github.com/Tkaixiang/marktext/releases) !
...
#### Windows
- Simplesmente confira a [Página de Lançamentos](https://github.com/Tkaixiang/marktext/releases)!
...
#### Windows
- Schauen Sie einfach auf die [Release-Seite](https://github.com/Tkaixiang/marktext/releases)!
